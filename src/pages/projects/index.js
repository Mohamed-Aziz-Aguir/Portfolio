      ...
      <div className='max-w-5xl mx-auto px-6 py-12'>
        ...
        <ul className='mt-6 grid sm:grid-cols-2 gap-4'>
          <li className='p-4 rounded-lg border border-slate-700 hover:border-indigo-600 transition-colors'>
            ...
            <p className='mt-2 text-slate-300/90'>Production CTI platform: FastAPI + Elasticsearch (8.13.4) + Redis + Docker, AI classification & similarity search; deployed on Ubuntu 24.04.</p>
          </li>
          <li className='p-4 rounded-lg border border-slate-700 hover:border-indigo-600 transition-colors'>
